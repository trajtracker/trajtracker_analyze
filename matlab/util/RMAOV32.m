function [table] = RMAOV32(X,alpha, display)
...
table = {...
        'SOV',          'SS','df','MS', 'F', 'p';
        'F1(between)',  SSA,  v1,  MSA,  F1,  P1;
        'Err(F1)',      SSEA, v2,  MSEA, [],  [];
        'F2(within)',   SSB,  v3,  MSB,  F2,  P2;
        'F1 x F2',      SSAB, v4,  MSAB, F3,  P3;
        'Err(F1xF2)',   SSEB, v5,  MSEB, [],  [];
        'F3(within)',   SSC,  v6,  MSC,  F4,  P4;
        'F1 x F3',      SSAC, v7,  MSAC, F5,  P5;
        'Err(F1xF3)',   SSEC, v8,  MSEC, [],  [];
        'F2 x F3',      SSBC, v9,  MSBC, F6,  P6;
        'F1 x F2 x F3', SSABC,v10, MSABC,F7,  P7;
        'Err(F2-F3)',   SSEBC,v11, MSEBC, [],  [];
        'Total',        SSTO, v12, [], [],  [];
    };
