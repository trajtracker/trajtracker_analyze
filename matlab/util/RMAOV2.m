function table = RMAOV2(X,alpha,display)
...
table = {...
        'SOV',          'SS','df','MS',  'F', 'p', 'eta2';
        'F1(within)',   SSA,  v1,  MSA,   F1,  P1, SSA/SSTO;
        'Err(F1)',      SSEA, v2,  MSEA,  [],  [], SSEA/SSTO;
        'F2(within)',   SSB,  v3,  MSB,   F2,  P2, SSB/SSTO;
        'Err(F2)',      SSEB, v4,  MSEB,  [],  [], SSEB/SSTO;
        'F1 x F2',      SSAB, v5,  MSAB,  F3,  P3, SSAB/SSTO;
        'Err(F1xF2)',   SSEAB,v6,  MSEAB, [],  [], SSEAB/SSTO;
        'Subjects',     SSS,  v7,  MSS,   [],  [], SSS/SSTO;
        'Error',        SSSE, v8,  MSSE,  [],  [], SSSE/SSTO;
        'Total',        SSTO, v9,  [],    [],  [], 1;
    };
