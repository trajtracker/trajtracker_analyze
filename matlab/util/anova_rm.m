...
if s > 1
    ...
    table = {'Source'              'SS' 'df'        'MS' 'F' 'Prob>F' 'eta2'            'eta2p'           'eta2g'                 'dfe'
             'Time'                ssT  t-1         msT  FT  pT        ssT/ssTotal      ssT/(ssT+ssR)     ssT/(ssTotal-ssG-ssGT)  (n-s)*(t-1)
             'Group'               ssG  s-1         msG  FG  pG        ssG/ssTotal      ssG/(ssG+ssR)     ssT/(ssTotal-ssT-ssGT)  n-s
             'Ineratcion'          ssGT (s-1)*(t-1) msGT FGT pGT       ssGT/ssTotal     ssGT/(ssGT+ssR)   ssT/(ssTotal-ssG-ssT)   (n-s)*(t-1)
