function [result] = RMAOV33(X,alpha, display)
...
result = { ...
    'Factor',              'SS',   'df',   'MS',   'F',    'p', 'eta2'; ...
    'Between-Subjects',    SSS,    v15,    [],     [],     [],  SSS/SSTO; ...
    'Within-Subjects',     SSWS,   vWS,    [],     [],     [],  SSWS/SSTO; ...
    ...
    'Factor 1',            SSA,    v1,     MSA,    F1,     P1,  SSA/SSTO; ...
    'Error(factor 1)',     SSEA,   v2,     MSEA,   [],     [],  SSEA/SSTO; ...
    'Factor 2',            SSB,    v3,     MSB,    F2,     P2,  SSB/SSTO; ...
    'Error(factor 2)',     SSEB,   v4,     MSEB,   [],     [],  SSEB/SSTO; ...
    'Factor 3',            SSC,    v5,     MSC,    F3,     P3,  SSC/SSTO; ...
    'Error(factor 3)',     SSEC,   v6,     MSEC,   [],     [],  SSEC/SSTO; ...
    ...
    'F1 x F2',             SSAB,   v7,     MSAB,   F4,     P4,  SSAB/SSTO; ...
    'Error(F1 x F2)',      SSEAB,  v8,     MSEAB,  [],     [],  SSEAB/SSTO; ...
    'F1 x F3',             SSAC,   v9,     MSAC,   F5,     P5,  SSAC/SSTO; ...
    'Error(F1 x F3)',      SSEAC,  v10,    MSEAC,  [],     [],  SSEAC/SSTO; ...
    'F2 x F3',             SSBC,   v11,    MSBC,   F6,     P6,  SSBC/SSTO; ...
    'Error(F2 x F3)',      SSEBC,  v12,    MSEBC,  [],     [],  SSEBC/SSTO; ...
    ...
    'F1 x F2 x F3',        SSABC,  v13,    MSABC,  F7,     P7,  SSABC/SSTO; ...
    'Error(F1 x F2 x F3)', SSEABC, v14,    MSEABC, [],     [],  SSEABC/SSTO; ...
    ...
    'Total',               SSTO,   v16,    [],     [],     [],  1 ...
};
