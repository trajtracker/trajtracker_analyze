function result = RMAOV1(X,alpha,silent)
...
anovaTab = { ...
    ...
    'Subjects', SSS,  v2,   MSS,  F2,  P2,  SSS/SST; ...
    'IV',       SSA,  v1,   MSA,  F1,  P1,  SSA/SST; ...
    'Error',    SSE,  v3,   MSE,  '',  '',  SSE/SST; ...
    'Total',    SST,  dfT,  '',   '',  '',  1 ...
};

result = struct('pSubj', P2, 'pFactor', P1);
result.tab = anovaTab;
